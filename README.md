...
Once you have the Buildkite agent token, you'll need to create a Kubernetes deployment that uses the agent-token and a service (don't apply until after creating secret):
```
